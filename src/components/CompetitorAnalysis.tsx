...
export function CompetitorAnalysis() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-gray-900 mb-2">Análisis de Competencia</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
        <h2 className="text-gray-900 mb-4">Agregar Dominio para Análisis</h2>
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-blue-900 text-white px-6 py-3 rounded-lg hover:bg-blue-800 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
        ...
        {/* Sugerencias */}
        <div className="mt-4">
          <p className="text-gray-600 mb-2">Dominios sugeridos:</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-gray-600">Dominios en Análisis</p>
          </div>
          <div className="text-gray-900">{domains.length} de 5</div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <p className="text-gray-600 mb-2">Tráfico Total Combinado</p>
          <div className="text-gray-900">
            {domains.reduce((sum, d) => sum + d.traffic, 0).toLocaleString()}
          </div>
          <p className="text-gray-500 mt-1">visitas/mes</p>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <p className="text-gray-600 mb-2">Keywords Totales</p>
          <div className="text-gray-900">
            {domains.reduce((sum, d) => sum + d.keywords, 0)}
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <p className="text-gray-600 mb-2">Mejor Performance</p>
      ...
      {/* Dominios agregados */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
        <h2 className="text-gray-900 mb-4">Resumen de Dominios</h2>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-1 text-sm">
                      <span className="text-gray-600">
                        Tráfico: <strong className="text-gray-900">{domain.traffic.toLocaleString()}</strong>
                      </span>
                      <span className="text-gray-600">
                        Keywords: <strong className="text-gray-900">{domain.keywords}</strong>
                      </span>
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    <div className="flex items-center gap-1">
                      ...
                      <span
                        className={
                          domain.trafficChange >= 0 ? 'text-green-600' : 'text-red-600'
                        }
                      >
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-gray-900 mb-1">Evolución del Tráfico Orgánico</h2>
              <p className="text-gray-600">
      ...
      {domains.length > 1 && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-gray-900 mb-1">Comparación de Keywords</h2>
            <p className="text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h2 className="text-gray-900">Palabras Clave de {selectedDomain.domain}</h2>
                <p className="text-gray-600">
